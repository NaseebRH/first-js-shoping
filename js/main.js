    ...
    data.forEach(item => {
      ...
      <div class="media mt-5">
          ...
          <div class="media-body">
            <a class="newsTitle" href="${item.url}" target="_blank"> <h3>${item.title}t</h3></a>
